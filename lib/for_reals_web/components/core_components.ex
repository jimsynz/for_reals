defmodule ForRealsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ForRealsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ForRealsWeb.Gettext, "errors", msg, opts)
    end
  end
